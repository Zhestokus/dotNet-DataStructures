...
{
    public class RWayTrieDictionary<TKey, TValue> : IDictionary<TKey, TValue>
    {
        private readonly RWayTrie<TKey, TValue> rway;

        public RWayTrieDictionary()
            : this(new BinaryFormatter())
        {
        }

        public RWayTrieDictionary(IFormatter keySerializer)
        {
            rway = new RWayTrie<TKey, TValue>(keySerializer);
        }
