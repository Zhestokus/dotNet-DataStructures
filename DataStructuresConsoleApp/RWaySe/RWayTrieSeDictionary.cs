...
{
    public class RWayTrieSeDictionary<TKey, TValue> : IDictionary<TKey, TValue>
    {
        private readonly RWayTrieSe<TKey, TValue> rway;

        public RWayTrieSeDictionary()
            : this(new BinaryFormatter())
        {
        }

        public RWayTrieSeDictionary(IFormatter keySerializer)
        {
            rway = new RWayTrieSe<TKey, TValue>(keySerializer);
        }
